...
func (e *CampaignToolExecutor) registerGetDeslabOpportunities() {
	e.register(ai.ToolDefinition{
		...
		Description: "Get cross-campaign crack arbitrage candidates: graded cards where selling raw is more profitable than selling graded. Shows crack vs graded net, advantage, and ROI.",
		Parameters:  emptyObjectParams,
	}, func(ctx context.Context, _ string) (string, error) {
