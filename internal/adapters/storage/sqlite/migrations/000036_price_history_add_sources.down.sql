-- Revert: restore price_history.source CHECK constraint to original values.
-- Note: rows with 'justtcg' or 'doubleholo' source will be dropped on downgrade.
...
INSERT INTO price_history_new
    ...
    FROM price_history
    WHERE source IN ('pricecharting', 'pokemonprice', 'cardmarket', 'cardhedger', 'fusion');
