...
-- 2. api_rate_limits: recreate with updated CHECK constraint
...
-- 3. price_refresh_queue: recreate with updated source CHECK constraint
...
-- 4. Recreate views that depend on api_calls
