...
func (m *DemandServiceMock) CampaignSignals(ctx context.Context) (demand.CampaignSignalsResponse, error) {
	if m.CampaignSignalsFn != nil {
		return m.CampaignSignalsFn(ctx)
	}
	return demand.CampaignSignalsResponse{}, nil
}
