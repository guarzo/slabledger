...
type MockTuningService struct {
	GetCampaignTuningFn func(ctx context.Context, campaignID string) (*tuning.TuningResponse, error)
}

var _ tuning.Service = (*MockTuningService)(nil)

func (m *MockTuningService) GetCampaignTuning(ctx context.Context, campaignID string) (*tuning.TuningResponse, error) {
