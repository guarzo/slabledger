...
func Default() Config {
	return Config{
		...
		// These settings add coarser-grained scheduling controls to prevent sustained
		// bursts from saturating upstream APIs.
		...
		DHAnalyticsRefresh: DHAnalyticsRefreshConfig{
			...
			RefreshHour: 3,     // 3 AM UTC, after DH nightly analytics rollup (~03:30 UTC)
			Window:      "30d",
		},
	}
}
