...
// ShopifyPriceSyncItem is a single item from a Shopify CSV for price matching.
type ShopifyPriceSyncItem struct {
	CertNumber        string `json:"certNumber"`
...
type ShopifyPriceSyncResponse struct {
	Matched   []ShopifyPriceSyncMatch `json:"matched"`
