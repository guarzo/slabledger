...
// SaleChannel is a type alias for constants.SaleChannel — re-exported from csvimport
// so callers can use csvimport.SaleChannel without importing constants directly.
