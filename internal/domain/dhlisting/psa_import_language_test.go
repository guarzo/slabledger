...
func TestInferDHLanguage(t *testing.T) {
	tests := []struct {
		...
		{"spanish", "POKEMON SPANISH PROMO", "Pikachu", "spanish"},
		{"korean", "Pokemon Korean Promo", "Lucario", "korean"},
		{"chinese simplified", "SIMPLIFIED CHINESE 151 C-COLLECTION 151", "Pikachu", "chinese_simplified"},
		{"chinese traditional", "TRADITIONAL CHINESE 151 COLLECTION", "Pikachu", "chinese_traditional"},
		{"chinese ambiguous defers to DH", "POKEMON CHINESE PROMO", "Mew", ""},
