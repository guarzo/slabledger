...
// listing. It delegates to inventory.ResolveListingPriceCents, which holds
// the single copy of the reviewed↔override precedence rule and documents it;
// this wrapper exists so the six existing dhlisting call sites keep working.
