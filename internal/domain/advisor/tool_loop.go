...
// Liquidation uses 3 rounds to accommodate batch tools and larger workflows
// (prompt says 2 rounds but suggest_price_batch may need a separate round
// after reading EV data).
