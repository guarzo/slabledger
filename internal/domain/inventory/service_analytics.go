...
func (s *service) GetCampaignPNL(ctx context.Context, campaignID string) (*CampaignPNL, error) {
	return s.analytics.GetCampaignPNL(ctx, campaignID)
}

func (s *service) GetPNLByChannel(ctx context.Context, campaignID string) ([]ChannelPNL, error) {
	return s.analytics.GetPNLByChannel(ctx, campaignID)
}
...
func (s *service) GetDaysToSellDistribution(ctx context.Context, campaignID string) ([]DaysToSellBucket, error) {
	return s.analytics.GetDaysToSellDistribution(ctx, campaignID)
}
...
func (s *service) applyOpenFlags(ctx context.Context, items []AgingItem) error {
	flaggedIDs, err := s.pricing.OpenFlagPurchaseIDs(ctx)
	if err != nil {
		if s.logger != nil {
