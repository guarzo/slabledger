...
describe('api module', () => {
  ...
  describe('APIClient fetch behavior', () => {
    ...
    it('GET request parses JSON response', async () => {
      const mockCampaigns: Campaign[] = [{ id: '1', name: 'Test', sport: '', yearRange: '', gradeRange: '', priceRange: '', clConfidence: '', buyTermsCLPct: 0, dailySpendCapCents: 0, targetLanguages: [], subjectFilterMode: 'Target', subjects: [], deniedSpecs: [], phase: 'pending', psaSourcingFeeCents: 0, ebayFeePct: 0, expectedFillRate: 0, createdAt: '', updatedAt: '', kind: 'standard' }];
