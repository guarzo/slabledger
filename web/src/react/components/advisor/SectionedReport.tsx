 ...
 *
 * Exported for tests. The parser is tolerant: trailing whitespace in heading
 * text is trimmed, and trailing blank lines in body content are preserved so
 * the downstream markdown renderer can re-hydrate paragraph spacing correctly.
 */
