...
and embedded in the binary via `embed.FS`. Migrations run automatically on startup. 56 migration pairs (`000001`–`000056`).

Migration files: `internal/adapters/storage/sqlite/migrations/` (56 migration pairs)
