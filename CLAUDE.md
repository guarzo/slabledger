...
and embedded in the binary via `embed.FS`. Migrations run automatically on startup. 54 migration pairs (`000001`–`000054`).

Migration files: `internal/adapters/storage/sqlite/migrations/` (54 migration pairs)
