...
and embedded in the binary via `embed.FS`. Migrations run automatically on startup. 42 migration pairs (`000001`–`000042`).

Migration files: `internal/adapters/storage/sqlite/migrations/` (42 migration pairs)
