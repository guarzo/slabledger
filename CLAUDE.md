...
and embedded in the binary via `embed.FS`. Migrations run automatically on startup. 55 migration pairs (`000001`–`000055`).

Migration files: `internal/adapters/storage/sqlite/migrations/` (55 migration pairs)
